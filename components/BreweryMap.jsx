...
const BreweryMap = ({ brewery }) => {
  ...
  useEffect(() => {
    ...
    const fetchCoords = async () => {
      try {
        ...
        const res = await fromAddress(`${brewery.location}`);
  ...
  }, [brewery.location]); // Dependency array ensures this effect runs when the property location changes
...
export default BreweryMap; // Export the component to be used in other parts of the application
